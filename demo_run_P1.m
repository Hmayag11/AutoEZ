...
%% load the data
load('sample_data_P1.mat')

%% plot the MRI in 3D and overlay resection and electrodes
V = niftiread('MRI_P1.nii');
V = rot90(V);
[X,Y,Z] = meshgrid(-0.1145:0.0011705:0.1858-0.0011705,-0.1363:0.00103:0.1276-0.00103,-0.0975:0.00115:0.1974-0.00115);
if figflag
    figure
    xslice =0;
    yslice = 0;
