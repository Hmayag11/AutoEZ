...
**Figure 3**. **Epileptogenic and background networks of good outcome patient 1.** The epileptogenic (red) and background (blue) networks generated by the framework are projected onto the MRI and overlapped with the resection volume (green).
...
**Figure 6**. **Epileptogenic and background networks in the band of poor outcome patient 31.** The epileptogenic (red) and background (blue) networks generated by the framework are projected onto the MRI and overlapped with the resection volume (green).
